...
public class MerchantForTransaction {
	...
	public String toString() {
		return "MerchantForTransaction [id=" + id + ", agentInfoId=" + agentInfoId + ", referenceNo=" + referenceNo
				...
				+ ", code=" + code + ", agent=" + agent + ", message=" + message + ", updatedAt=" + updatedAt
				+ ", customData=" + customData + ", createdAt=" + createdAt + ", merchantId=" + merchantId
				+ ", acquirerTransactionId=" + acquirerTransactionId + ", channel=" + channel + "]";
	}
